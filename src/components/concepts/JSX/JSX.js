        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <dl>
                    ...
                    <dt>Not required</dt>
                    <dd>Although not required by React, JSX is the widespread defacto go-to for most React developers - as JSX acts as a helpful visual aid when working with UI in JavaScript code.</dd>
                </dl>
                <hr/>
                <NormalComponent/>
                <br/>
